		...
		<li{if $isSelected} class="thumbSelected"{/if}>
			<span class="wrap1">
				<label class="font-checkbox">
					...
					<span class="wrap2">
					<div class="actions"><a href="{$thumbnail.path}" class="preview-box">{'Zoom'|@translate}</a> &middot; <a href="{$thumbnail.U_EDIT}" target="_blank">{'Edit'|@translate}</a></div>
						...
						{/if}
						<img src="{$thumbnail.path}" alt="{$thumbnail.path}" title="{$thumbnail.TITLE|@escape:'html'}" width="144" height="96">
					</span>
				</label>
			</span>
		</li>
